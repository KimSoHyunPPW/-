	...
	$(function() {
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				...
				{field:'aclass',title:'班级',width:200},
	 		]], 
	        toolbar: "#toolbar"
	    });
	    ...
	    $("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_aclass").textbox('setValue', selectRow.aclass);
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin-left:10px;margin-top: 3px">姓名：<input id="search-name" class="easyui-textbox" name="name" /></div>
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>密码:</td>
	    			<td><input id="add_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="psssword" name="password" data-options="required:true, missingMessage:'请填写密码'" /></td>
	    		</tr>
				<tr>
					<td>电话:</td>
					<td><input id="add_tel" style="width: 200px; height: 30px;" class="easyui-textbox" type="tel" name="tel" data-options="required:true, missingMessage:'请填写电话'" /></td>
				</tr>
				<tr>
					<td>班级:</td>
					<td><input id="add_aclass" style="width: 200px; height: 30px;" class="easyui-textbox" type="aclass" name="aclass" data-options="required:true, missingMessage:'请填写班级名'" /></td>
				</tr>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
				...
				<tr>
					<td>密码:</td>
					<td><input id="edit_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="password" validType="psasswprd" /></td>
				</tr>
	    		<tr>
	    			<td>电话:</td>
	    			<td><input id="edit_tel" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="tel" validType="tel" /></td>
	    		</tr>

	    		<tr>
	    			<td>班级:</td>
	    			<td><input id="edit_aclass" style="width: 200px; height: 30px;" class="easyui-textbox" name="aclass" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
