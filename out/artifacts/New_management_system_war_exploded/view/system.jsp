...
<head>
    ...
    <script type="text/javascript">
        var _menus = {"menus":[
                ...
                {"menuid":"2","icon":"","menuname":"成绩管理",
                    "menus":[
                        {"menuid":"21","menuname":"成绩列表","icon":"icon-user-student","url":"DormitoryManagerServlet?method=toDormitoryManagerListView"},
                    ]
                },
...
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">Copyright &copy; By 跟我回江南</div>
</div>
